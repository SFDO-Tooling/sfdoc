"""
Django settings for sfdoc project.
...
# ------------------------------------------------------------------------------
MIGRATION_MODULES = {"sites": "sfdoc.contrib.sites.migrations"}
...
DATABASES = {"default": env.db("DATABASE_URL", default="postgres:///sfdoc")}
...
ACCOUNT_EMAIL_VERIFICATION = env(
    "DJANGO_ACCOUNT_EMAIL_VERIFICATION", default="mandatory"
)

ACCOUNT_ALLOW_REGISTRATION = env.bool("DJANGO_ACCOUNT_ALLOW_REGISTRATION", True)
ACCOUNT_ADAPTER = "sfdoc.users.adapters.AccountAdapter"
SOCIALACCOUNT_ADAPTER = "sfdoc.users.adapters.SocialAccountAdapter"
...
SALESFORCE_ARTICLE_TEXT_INDEX_FIELD = env(
    "SALESFORCE_ARTICLE_TEXT_INDEX_FIELD", default=""
)
SALESFORCE_ARTICLE_LINK_LIMIT = env("SALESFORCE_ARTICLE_LINK_LIMIT", default=100)
SALESFORCE_API_VERSION = env("SALESFORCE_API_VERSION", default="41.0")
