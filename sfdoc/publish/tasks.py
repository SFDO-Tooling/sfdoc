    ...
    for dirpath, dirnames, filenames in os.walk(path):
        ...
        if html_files:
            ...
            if docset.index_article_url != article_data["UrlName"]:
                docset.index_article_url = article_data[
                    "UrlName"
                ]  # To find the ka_id later 4 Hub_Product_Description
                docset.index_article_ka_id = (
                    None  # Clear this to remember to update it later
                )
            docset.save()
...
def process_bundle_queues():
    ...
    if bundles:
        ...
        relevant_docsets = {
            bundle.easydita_resource_id: bundle.easydita_resource_id
        ...
        for docset_id in relevant_docsets:
            ...
            if not any(docset_bundles_being_processed_already):
                queued_bundles_for_docset = bundles_for_docset.filter(
